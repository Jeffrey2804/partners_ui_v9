// ========================================
// KanbanColumn (Professional, Smooth, JS) — UPDATED
// ========================================
...
// ✅ Do NOT drop id-less items anymore
const dedupeLeads = (list = []) => {
  ...
  for (const lead of list) {
    ...
    if (uid) seen.add(uid);
    out.push(lead); // keep id-less too
  }
  return out;
};
              ...
              return (
                ...
                >
                  <KanbanCard
                    ...
                    onDelete={onDeleteLead} // ⬅️ now connected
                  />
                </motion.div>
              );
            })}
...
KanbanColumn.propTypes = {
  stage: PropTypes.shape({ title: PropTypes.string.isRequired }).isRequired,
  ...
  onDeleteLead: PropTypes.func, // ⬅️ new
